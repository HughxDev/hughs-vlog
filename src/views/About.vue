<template>
  <article>
    ...
    <p><i>Full disclosure, though: <!--I’ve got ADHD. The legit kind. It makes me allergic to being put in a box. So -->in addition to “entrepreneur”, I wear many other hats: web developer, UX designer, comedian, filmmaker, writer… the list goes on. Since this is a daily documentary series, it will inevitably veer off-topic into these other interests at times. But I’ll be sure to always bring it back to my journey as a startup founder.</i></p>
    <section>
      <header>
      ...
      <p>Enter&nbsp;<a href="https://redblue.video/">RedBlue</a>. We (well, just me at the moment) enable more people to produce hypervideo by democratizing the technology behind it. We author an open specification, HVML (Hypervideo Markup Language), which aims to be the HTML of video. In conjunction, we develop the RedBlue JavaScript player, which brings the immersive features of HVML to any website.</p>
      <p>These core offerings will be completely free to download and use. Monetization will be achieved through premium products and services based on these technologies, such as plug-ins and support.</p>
      <p>There are some other exciting products on the roadmap, but for now… 🤐</p>
    </section>
    <!-- <section>
      <header>
